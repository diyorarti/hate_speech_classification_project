...
class DataTransformation:
    ...
    def imbalance_data_cleaning(self):
        ...
        try:
            ...
            imbalance_data = pd.read_csv(self.data_ingestion_artifacts.hatespeechdataset_data_file_path)
            # Let's change the name of the 'Label' to "label" and "Content" to "tweet"
            imbalance_data.rename(columns={self.data_transformation_config.LABEL1:self.data_transformation_config.LABEL})
    ...
    def raw_data_cleaning(self):
        ...
        try:
            ...
            raw_data = pd.read_csv(self.data_ingestion_artifacts.labeled_data_file_path)
    ...
    # although I don't apply this following concat_data_cleaning funtion due to my computer accelerator power 
